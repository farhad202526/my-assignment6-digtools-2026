...
const Star = () => {
    return (<div className="stats stats-vertical lg:stats-horizontal shadow  w-full text-center   px-4 py-4 bg-[#2913d4]  mx-auto my-7 text-amber-50  border-4 border-indigo-500">
